...
setTimeout(()=>{const b=e('uploadBtn');if(b)b.onclick=saveDoc;const s=document.createElement('script');s.src='driver-state.js?v=1';document.body.appendChild(s);const g=document.createElement('script');g.src='driver-location.js?v=1';document.body.appendChild(g)},500);
})();