...
function loadUpgrades(){loadOne('tmsDashboardStable','tms-dashboard-stable.js?v=5200');loadOne('dashboardFix','dashboard-fix.js?v=6400');loadOne('tmsDocsStable','tms-docs-stable.js?v=5200');loadOne('storageUploadHelper','storage-upload.js?v=5400');loadOne('storageManageHelper','storage-manage.js?v=5500');loadOne('inviteAdmin','invite-admin.js?v=6600')}
