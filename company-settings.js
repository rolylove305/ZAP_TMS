...
function loadUpgrades(){[['tmsDashboardStable','tms-dashboard-stable.js?v=5200'],['tmsDocsStable','tms-docs-stable.js?v=5200']].forEach(x=>{if(q('#'+x[0]))return;const s=document.createElement('script');s.id=x[0];s.src=x[1];document.body.appendChild(s)})}
