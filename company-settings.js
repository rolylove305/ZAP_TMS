...
function loadUpgrades(){loadOne('tmsDashboardStable','tms-dashboard-stable.js?v=5200');loadOne('tmsDocsStable','tms-docs-stable.js?v=5200');loadOne('storageUploadHelper','storage-upload.js?v=5400');loadOne('storageManageHelper','storage-manage.js?v=5500')}
