...
function loadUpgrades(){loadOne('tmsDashboardStable','tms-dashboard-stable.js?v=completed-filter-1');loadOne('dashboardFix','dashboard-fix.js?v=6500');loadOne('tmsDocsStable','tms-docs-stable.js?v=5200');loadOne('storageUploadHelper','storage-upload.js?v=5400');loadOne('storageManageHelper','storage-manage.js?v=5500')/* invite-admin removed: invite-only replaced by open signup; user admin lives in admin-users.js */}
