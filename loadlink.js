...
function helpers(){if(!document.getElementById('phase2Helper')){const s=document.createElement('script');s.id='phase2Helper';s.src='phase2.js?v=5900';document.body.appendChild(s)}const invoiceVersion='step5-invoice-print';if(window.ZAP_INVOICE_SELECT_LOADED!==invoiceVersion&&!document.getElementById('invoiceSelectHelper')){const h=document.createElement('script');h.id='invoiceSelectHelper';h.src='invoice-select.js?v='+invoiceVersion;document.body.appendChild(h)}}
