...
function helpers(){addHelper('phase2Helper','phase2.js?v=load-folder-single-source-1');addHelper('invoiceSelectHelper','invoice-select.js?v=select-label-3');addHelper('savedInvoicesHelper','saved-invoices.js?v=load-charge-1')}
function runAll(){add()}
