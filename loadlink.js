...
function helpers(){addHelper('phase2Helper','phase2.js?v=step5-archive-visible');addHelper('invoiceSelectHelper','invoice-select.js?v=release-invoices-safe-fix2');addHelper('savedInvoicesHelper','saved-invoices.js?v=step6-delete-direct')}
