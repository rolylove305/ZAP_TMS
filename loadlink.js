...
function helpers(){addHelper('phase2Helper','phase2.js?v=step5-archive-visible');addHelper('invoiceSelectHelper','invoice-select.js?v=release-invoices-safe-fix4');addHelper('savedInvoicesHelper','saved-invoices.js?v=release-invoices-safe-fix4')}
