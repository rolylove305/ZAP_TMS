...
function helpers(){addHelper('phase2Helper','phase2.js?v=5900');addHelper('invoiceSelectHelper','invoice-select.js?v=step4e-devicegmail');addHelper('savedInvoicesHelper','saved-invoices.js?v=step5-savedinvoices')}
