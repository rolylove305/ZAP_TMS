...
function helpers(){addHelper('phase2Helper','phase2.js?v=step5-archive-visible');addHelper('invoiceSelectHelper','invoice-select.js?v=commission-lock-1');addHelper('savedInvoicesHelper','saved-invoices.js?v=release-invoices-safe-fix5')}
function runAll(){add()}
