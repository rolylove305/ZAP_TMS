...
const map={
  ...
  fleet_people:{
    ...
    fromDb:x=>({id:x.id,personType:x.person_type,name:x.name,phone:x.phone,email:x.email,truckNumber:x.truck_number,trailerNumber:x.trailer_number,equipment:x.equipment,payType:x.pay_type,payRate:x.pay_rate,active:x.active,notes:x.notes,createdAt:x.created_at,organizationId:x.organization_id})
  }
};
